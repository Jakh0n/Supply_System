...
const QuickActionSkeleton = () => {
	return (
		<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6'>
			...
			{/* Skeleton for Team Orders Card */}
			<div className='block'>
				<div className='cursor-pointer hover:shadow-lg transition-all duration-200 h-full border-l-4 border-l-purple-500 hover:border-l-purple-600'>
					<div className='p-4 sm:p-6'>
						<div className='flex items-center text-base sm:text-lg'>
							<Skeleton className='h-5 w-5 sm:h-6 sm:w-6 bg-gray-300 rounded-lg mr-3' />
							<Skeleton className='h-4 w-1/2 sm:w-2/3 bg-gray-300 rounded-md' />
			...
			{/* Skeleton for Drink Order Card */}
			<div className='block'>
				<div className='cursor-pointer hover:shadow-lg transition-all duration-200 h-full border-l-4 border-l-cyan-500 hover:border-l-cyan-600'>
					<div className='p-4 sm:p-6'>
						<div className='flex items-center text-base sm:text-lg'>
							<Skeleton className='h-5 w-5 sm:h-6 sm:w-6 bg-gray-300 rounded-lg mr-3' />
							<Skeleton className='h-4 w-1/2 sm:w-2/3 bg-gray-300 rounded-md' />
