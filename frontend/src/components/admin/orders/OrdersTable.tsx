...
const OrdersTable: React.FC<OrdersTableProps> = ({
	...
	return (
		<>
							...
							<table className='w-full'>
								<thead className='bg-gray-50 sticky top-0 z-10'>
									<tr className='border-b'>
										<th className='text-left py-3 px-4 font-medium bg-gray-50 text-sm'>
											Order #
										</th>
										<th className='text-left py-3 px-4 font-medium bg-gray-50 text-sm'>
											Worker
										...
										<th className='text-right py-3 px-4 font-medium bg-gray-50 text-sm'>
											Actions
										</th>
									</tr>
								</thead>
			...
			{/* Pagination */}
			{totalPages > 1 && (
				<div className='flex flex-col sm:flex-row items-center justify-between gap-4 px-4 py-3 border-t bg-white rounded-lg'>
